...
pub const LIBLTC_VERSION: &[u8; 6] = b"1.3.2\0";
pub const LIBLTC_VERSION_MAJOR: u32 = 1;
pub const LIBLTC_VERSION_MINOR: u32 = 3;
pub const LIBLTC_VERSION_MICRO: u32 = 2;
pub const LIBLTC_CUR: u32 = 13;
pub const LIBLTC_REV: u32 = 0;
pub const LIBLTC_AGE: u32 = 2;
...
pub type LTC_TV_STANDARD = ::std::os::raw::c_uint;
...
pub type LTC_BG_FLAGS = ::std::os::raw::c_uint;
...
fn bindgen_test_layout_LTCFrameExt() {
    const UNINIT: ::std::mem::MaybeUninit<LTCFrameExt> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ltc) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).off_start) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(LTCFrameExt),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).off_end) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(LTCFrameExt),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).biphase_tics) as usize - ptr as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(LTCFrameExt),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sample_min) as usize - ptr as usize },
        356usize,
        concat!(
            "Offset of field: ",
            stringify!(LTCFrameExt),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).sample_max) as usize - ptr as usize },
        357usize,
        concat!(
            "Offset of field: ",
            stringify!(LTCFrameExt),
...
fn bindgen_test_layout_SMPTETimecode() {
    const UNINIT: ::std::mem::MaybeUninit<SMPTETimecode> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).mins) as usize - ptr as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(SMPTETimecode),
...
extern "C" {
    #[doc = " Wrapper around \\ref ltc_decoder_write that accepts 32-bit floating point\n audio samples. Note: internally libltc uses 8 bit only.\n\n @param d decoder handle\n @param buf pointer to audio sample data\n @param size number of samples to parse\n @param posinfo (optional, recommended) sample-offset in the audio-stream."]
...
extern "C" {
    #[doc = " Copy the accumulated encoded audio to the given\n sample-buffer and flush the internal buffer.\n\n @param e encoder handle\n @param buf place to store the audio-samples, needs to be large enough\n to hold \\ref ltc_encoder_get_buffersize bytes\n @return the number of bytes written to the memory area\n pointed to by buf."]
    pub fn ltc_encoder_copy_buffer(
        e: *mut LTCEncoder,
        buf: *mut ltcsnd_sample_t,
    ) -> ::std::os::raw::c_int;
}
...
extern "C" {
    ...
    pub fn ltc_encoder_get_bufferptr(
        e: *mut LTCEncoder,
...
extern "C" {
    #[doc = " Configure a custom size for the internal buffer.\n\n This is needed if you are planning to call \\ref ltc_encoder_reinit()\n or if you want to keep more than one LTC frame's worth of data in\n the library's internal buffer.\n\n The buffer-size is (1 + sample_rate / fps) bytes.\n resizing the internal buffer will flush all existing data\n in it - alike \\ref ltc_encoder_buffer_flush.\n\n @param e encoder handle\n @param sample_rate audio sample rate (eg. 48000)\n @param fps video-frames per second (e.g. 25.0)\n @return 0 on success, -1 if allocation fails (which makes the\n   encoder unusable, call \\ref ltc_encoder_free or realloc the buffer)"]
    pub fn ltc_encoder_set_buffersize(
        e: *mut LTCEncoder,
        sample_rate: f64,
        fps: f64,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    #[doc = " Query the volume of the generated LTC signal\n\n @param e encoder handle\n @return the volume in dB full-scale (<= 0.0)"]
    pub fn ltc_encoder_get_volume(e: *mut LTCEncoder) -> f64;
}
extern "C" {
...
extern "C" {
    #[doc = " Get encoder signal rise-time / signal filtering\n\n @param e encoder handle\n @return the signal rise-time in us (10^(-6) sec)"]
    pub fn ltc_encoder_get_filter(e: *mut LTCEncoder) -> f64;
}
extern "C" {
...
extern "C" {
    #[doc = " Encode a full LTC frame at fixed speed -1.\n This is equivalent to calling \\ref ltc_encoder_encode_byte 10 times for\n bytes 9..0, rolling in reverse at speed 1.\n\n Note: The internal buffer must be empty before calling this function.\n Otherwise it may overflow. This is usually the case if it is read with\n \\ref ltc_encoder_copy_buffer after calling this function.\n\n @param e encoder handle"]
    pub fn ltc_encoder_encode_reversed_frame(e: *mut LTCEncoder);
}
extern "C" {
